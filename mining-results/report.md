# Refactoring Mining Report — 2026-07-02
...
- `bundles/org.eclipse.ui.workbench/eclipseui/org/eclipse/ui/internal/quickaccess/QuickAccessContents.java:536` — `entry.getValue().stream().map(QuickAccessElement::getId).collect(Collectors.t...`
- `bundles/org.eclipse.ui.workbench/eclipseui/org/eclipse/ui/internal/quickaccess/QuickAccessContents.java:566` — `elementsPerProvider.getValue().stream().map(element -> matcher.match(element,...`
...
<!-- report-hash: a7a3fa29031e5b949ce77b348d92acef0451709e56f24cb833bd079ef402cd10 -->
