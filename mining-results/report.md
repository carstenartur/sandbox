# Refactoring Mining Report — 2026-06-29

## Summary
| Eclipse Project | Files | Matches | Rules |
|----------------|-------|---------|-------|
| eclipse.jdt.core | 227 | 86 | 2 |
| eclipse.jdt.ui | 1470 | 54 | 3 |
| eclipse.platform.ui | 1147 | 31 | 4 |
...
#### Rule: `modernize-java11` → `modernize-java115`
...
### sandbox
#### Rule: `collections` → `collections20`
...
#### Rule: `collections` → `collections21`
- `sandbox-ast-api/src/main/java/org/sandbox/ast/api/expr/InfixExpr.java:127` — `new java.util.ArrayList<ASTExpr>()` → `new java.util.ArrayList<>()`
...
<!-- report-hash: 6acfe390a594524179f10a38c773e402070c744456cf14df0536e870ca503115 -->
