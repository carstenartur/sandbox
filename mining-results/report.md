# Refactoring Mining Report — 2026-06-11

## Summary
| Eclipse Project | Files | Matches | Rules |
|----------------|-------|---------|-------|
| eclipse.jdt.core | 227 | 86 | 2 |
| eclipse.jdt.ui | 1468 | 54 | 3 |
| eclipse.platform.ui | 1146 | 31 | 4 |
...
## Details
### eclipse.jdt.core
#### Rule: `collections` → `Widens raw Hashtable type reference to Map interface (e.g., in declarations, casts).`
...
- `bundles/org.eclipse.ui.workbench/eclipseui/org/eclipse/ui/internal/Workbench.java:46` — `java.util.Hashtable` → `java.util.Map`
...
#### Rule: `collections` → `Replaces new Hashtable() with new HashMap() for local variables (performance/modernization). Guarded to preserve thread-safety semantics for non-local variables.`
...
- `bundles/org.eclipse.ui.workbench/eclipseui/org/eclipse/ui/internal/dialogs/PropertyDialog.java:71` — `"".equals(name)` → `name != null && name.isEmpty()`
...
- `bundles/org.eclipse.ui.workbench/eclipseui/org/eclipse/ui/internal/misc/Policy.java:192` — `"".equals(DEBUG_HANDLERS_VERBOSE_COMMAND_ID)` → `DEBUG_HANDLERS_VERBOSE_COMMAND_ID != null && DEBUG_HANDLERS_VERBOSE_COMMAND_I...`
...
<!-- report-hash: d99c5df4ae9a22ee57b3543f0f4670fb91baf34c600114b49c0892bb18da4ad4 -->
