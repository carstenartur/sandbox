# Refactoring Mining Report — 2026-07-23
...
#### Rule: `modernize-java9` → `modernize-java16.stream-collect-tolist.consider-stream-tolist`
- `sandbox_junit_cleanup/src/org/sandbox/jdt/internal/ui/fix/JUnitCleanUpCore.java:149` — `computeFixSet().stream().map(JUnitCleanUpFixCore::toString).collect(Collector...`
...
- `sandbox_int_to_enum/src/org/sandbox/jdt/internal/ui/fix/IntToEnumCleanUpCore.java:157` — `computeFixSet().stream().map(IntToEnumFixCore::toString).collect(Collectors.t...`
...
<!-- report-hash: 537b8a50a5049dd880359a34fd65ff71a147fde7598aa111168b23967b2705f9 -->
