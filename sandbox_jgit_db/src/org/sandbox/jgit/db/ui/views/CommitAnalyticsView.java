 ...
 *     Carsten Hammer
 *******************************************************************************/
package org.sandbox.jgit.db.ui.views;
...
/**
 * Eclipse view displaying commit analytics and author statistics for
 * Git repositories.
 *
 * <p>
 * Shows:
...
public class CommitAnalyticsView extends ViewPart {
	...
	public static final String ID = "org.sandbox.jgit.db.views.CommitAnalyticsView"; //$NON-NLS-1$
