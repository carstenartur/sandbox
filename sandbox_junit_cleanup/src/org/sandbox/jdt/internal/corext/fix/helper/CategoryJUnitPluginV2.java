 ...
 * 
 * <p>This is a simplified version using TriggerPattern for the find() logic
 * but with custom process2Rewrite() for handling array values.</p>
 * 
...
public class CategoryJUnitPluginV2 extends TriggerPatternCleanupPlugin {
	...
	public String toString() {
		return "Category (TriggerPattern)"; //$NON-NLS-1$
	}
}
