...
/**
 * Migrates JUnit 4 @Test annotations (without parameters) to JUnit 5 @Test.
 * 
 ...
 * 
 * <p><b>Note:</b> @Test annotations with expected or timeout parameters are handled
 * by separate plugins ({@link TestExpectedJUnitPlugin}, {@link TestTimeoutJUnitPlugin}).</p>
 * 
 * <p><b>Before:</b></p>
 * <pre>
...
public class TestJUnitPluginV2 extends TriggerPatternCleanupPlugin {
	...
	protected boolean shouldProcess(Match match, Pattern pattern) {
		// Only process simple @Test annotations (MarkerAnnotation)
		// NormalAnnotations with expected/timeout are handled by other plugins
		return match.getMatchedNode() instanceof MarkerAnnotation;
	}
