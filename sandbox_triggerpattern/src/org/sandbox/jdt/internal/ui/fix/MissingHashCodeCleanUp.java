...
/**
 * Wrapper for missing hashCode() cleanup.
 *
...
public class MissingHashCodeCleanUp extends AbstractCleanUpCoreWrapper<MissingHashCodeCleanUpCore> {
	...
	public MissingHashCodeCleanUp(final Map<String, String> options) {
		super(options, new MissingHashCodeCleanUpCore());
	}

	public MissingHashCodeCleanUp() {
