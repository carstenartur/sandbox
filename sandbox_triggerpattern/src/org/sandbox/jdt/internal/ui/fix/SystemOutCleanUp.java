...
/**
 * Wrapper for System.out/System.err cleanup.
 *
...
public class SystemOutCleanUp extends AbstractCleanUpCoreWrapper<SystemOutCleanUpCore> {
	...
	public SystemOutCleanUp(final Map<String, String> options) {
		super(options, new SystemOutCleanUpCore());
	}

	public SystemOutCleanUp() {
