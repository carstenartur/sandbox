...
public class CleanUpMessages {
	...
	public static String JavaFeatureTabPage_CheckboxName_JFACE_CLEANUP_MONITOR;
	public static String JavaFeatureTabPage_CheckboxName_JFACE_CLEANUP_VIEWER_SORTER;
	public static String JavaFeatureTabPage_CheckboxName_JFACE_CLEANUP_IMAGE_DPI;
