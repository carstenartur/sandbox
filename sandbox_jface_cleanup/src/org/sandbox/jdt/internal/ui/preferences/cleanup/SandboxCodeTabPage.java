...
import org.sandbox.jdt.internal.ui.fix.JFaceCleanUp;
...
public class SandboxCodeTabPage extends AbstractCleanUpTabPage {
	...
	public static final String ID= "org.eclipse.jdt.ui.cleanup.tabpage.sandbox.jface"; //$NON-NLS-1$

	@Override
	protected AbstractCleanUp[] createPreviewCleanUps(Map<String, String> values) {
		return new AbstractCleanUp[] { new JFaceCleanUp(values) };
	}
