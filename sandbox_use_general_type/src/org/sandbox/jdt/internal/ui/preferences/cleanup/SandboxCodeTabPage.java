...
public class SandboxCodeTabPage extends AbstractCleanUpTabPage {
	...
	public static final String ID= "org.eclipse.jdt.ui.cleanup.tabpage.sandbox.general_type"; //$NON-NLS-1$
	...
	protected void doCreatePreferences(Composite composite, int numColumns) {
		PlatformUI.getWorkbench().getHelpSystem().setHelp(composite,
				"sandbox_use_general_type.cleanup_configuration"); //$NON-NLS-1$
