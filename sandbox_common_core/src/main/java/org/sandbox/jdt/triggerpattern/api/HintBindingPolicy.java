 ...
 * a hint program without otherwise interpreting the DSL.
 *
 ...
 * {@link #REQUIRED} is the fail-closed mode for migrations whose correctness
 * depends on overload, owner, type or hierarchy information.</p>
 *
