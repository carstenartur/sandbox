 ...
 * operations, side effects without variable usage, operation merging, and
 * other advanced patterns that don't fit cleanly into simple forEach, filter,
 * map, or reduce categories.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * <b>Conversion Rule:</b> When loop operations create variables that are
 * not used in subsequent statements, the cleanup uses {@code _item} as the
 * lambda parameter name and wraps operations in map blocks.
 * </p>
 */
 ...
 * converted to map operations that return {@code _item}, with the side
 * effects executed in the lambda body.
 * </p>
 */
