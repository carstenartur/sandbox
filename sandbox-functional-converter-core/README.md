...
- [EnhancedForHandler.java](../sandbox_functional_converter/src/org/sandbox/jdt/internal/corext/fix/helper/EnhancedForHandler.java) - Handler for enhanced for-loops
