...
import org.sandbox.jdt.internal.ui.fix.SimplifyPlatformStatusCleanUp;
...
public class SandboxCodeTabPage extends AbstractCleanUpTabPage {
	...
	public static final String ID= "org.eclipse.jdt.ui.cleanup.tabpage.sandbox.platform"; //$NON-NLS-1$

	@Override
	protected AbstractCleanUp[] createPreviewCleanUps(Map<String, String> values) {
		return new AbstractCleanUp[] { new SimplifyPlatformStatusCleanUp(values) };
	}

	@Override
	protected void doCreatePreferences(Composite composite, int numColumns) {
		PlatformUI.getWorkbench().getHelpSystem().setHelp(composite,
				"sandbox_platform_helper.cleanup_configuration"); //$NON-NLS-1$
		Group java1d8Group= createGroup(numColumns, composite, CleanUpMessages.JavaFeatureTabPage_GroupName_Java1d8);
		final CheckboxPreference simplify_status= createCheckboxPref(java1d8Group, numColumns,
