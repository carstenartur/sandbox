...
Repository baseline: Java 21, Tycho 5.0.3, Eclipse 2026-06.
...
| `method-reuse` | cleanup | local | `sandbox_method_reuse` / `sandbox_method_reuse_feature` | 5/5 enabled | product, update site | not-assessed / no | conservative | experimental | — |
