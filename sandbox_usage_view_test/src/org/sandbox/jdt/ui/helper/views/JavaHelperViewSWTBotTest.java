...
public class JavaHelperViewSWTBotTest {
    ...
    public void testOpenView() {
        ...
        // Verify view is open
        SWTBotView view = bot.viewByTitle(VIEW_TITLE);
        assertNotNull(view, "JavaHelper View should be open");
        assertTrue(view.isActive() || bot.viewByTitle(VIEW_TITLE) != null, 
                "JavaHelper View should exist");
    }
    ...
    public void testViewHasTable() {
        ...
        assertNotNull(table, "View should contain a table");
        
        // Verify table has columns (column count > 0)
        int columnCount = table.columnCount();
        assertTrue(columnCount > 0, "Table should have columns, found: " + columnCount);
    }
    ...
    public void testLinkWithSelectionToggle() {
        ...
        try {
            ...
            assertNotNull(linkButton, "Link with Selection button should exist");
    ...
    public void testFilterNamingConflictsButton() {
        ...
        try {
            ...
            assertNotNull(filterButton, "Filter Naming Conflicts button should exist");
        } catch (WidgetNotFoundException e) {
