...
- ❌ Trailing/inline comments (after statements on same line)
...
**New Tests Added:**
1. `test_EndToEnd_TrailingInlineCommentsAttached()` - Verifies println with trailing comment
2. `test_EndToEnd_FilterWithTrailingComment()` - Verifies if-continue with trailing comment

**All Tests Pass:**
- ✅ 4 CommentPreservationTest (core module)
- ✅ 10 CommentPreservationIntegrationTest (with new trailing tests)
- ✅ 219 total core module tests
...
| **Embedded** | Inside statement | `if (/* comment */ x)` | ⚠️ Limited support |
...
- [Examples](EXAMPLES.md#trailinginline-comments-after-statement--new)
