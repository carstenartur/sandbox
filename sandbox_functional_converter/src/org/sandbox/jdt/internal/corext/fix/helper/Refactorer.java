...
public class Refactorer {
	...
	public boolean isRefactorable() {
		prospectives = this.getListRepresentation((ExpressionStatement)loop.getBody(), true);
...
//            }
	...
	private List<ProspectiveOperation> getIfListRepresentation( Statement tree, boolean last) {
        ...
        if (ifTree.getElseStatement() == null) {
            ...
            if (then.getNodeType() == ASTNode.RETURN_STATEMENT) {
                ...
                if (returnExpression.getNodeType() == ASTNode.BOOLEAN_LITERAL && ((BooleanLiteral) returnExpression).booleanValue() == true) {
                ...
                } else if (returnExpression.getNodeType() == ASTNode.BOOLEAN_LITERAL && ((BooleanLiteral) returnExpression).booleanValue() ==false) {
	 ...
	 private boolean isReturningIf( IfStatement ifTree) {
        ...
        if (then.getNodeType() == ASTNode.RETURN_STATEMENT) {
            return true;
        } else if (then.getNodeType() == ASTNode.BLOCK) {
	...
	private MethodInvocation chainAllProspectives(AST ast, Expression expr,ASTRewrite rewrite) {
		...
		LambdaExpression lambdaExpression= ast.newLambdaExpression();
 		...
 		Expression createMoveTarget = (Expression) ASTNodes.createMoveTarget(rewrite, loopBody.getExpression());
